...
default_input_dir = '/home/q23301273/cirl_new/data/datalists_office_home'
...
def get_fourier_train_dataloader(
    ...
    for dname in source_list:
        datalists_folder = get_datalists_folder(args) # args.input_dir
...
def get_val_dataloader(source_list=None, batch_size=64, image_size=224, args=None, config=None):
    ...
    for dname in source_list:
        ...
        val_dataset = get_dataset(args=args, path=path, train=False, image_size=image_size, config=data_config) # DGDataset
